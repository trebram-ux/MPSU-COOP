# Generated by Django 4.2.1 on 2025-01-19 08:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_fee', models.DecimalField(decimal_places=2, default=Decimal('0.03'), max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interest_rate', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=5, verbose_name='Interest Rate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_place', models.CharField(blank=True, default='Not Provided', max_length=100)),
                ('age', models.CharField(blank=True, default='Unknown', max_length=100)),
                ('zip_code', models.CharField(blank=True, default='0000', max_length=100)),
                ('height', models.CharField(blank=True, default='Not Provided', max_length=100)),
                ('weight', models.CharField(blank=True, default='Not Provided', max_length=100)),
                ('ann_com', models.CharField(blank=True, default='0', max_length=100)),
                ('co_maker', models.CharField(blank=True, max_length=255, null=True)),
                ('relationship', models.CharField(default='Not Provided', max_length=100)),
